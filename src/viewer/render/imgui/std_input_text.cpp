...
bool ocr::viewer::render::imgui::std_input_text(const char *label,
                                                std::string &str,
   ...
   return ImGui::InputText(label, (char *)str.c_str(), str.capacity() + 1, flags, internal::callback_t, &cb_user_data);
}